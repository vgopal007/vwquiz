      ...
      const app = Vue.createApp({
		...
		/*
		getUserResponse() {
            fetch('/get_user_response/')
                .then(response => response.json())
                .then(data => {
                    this.questions = data.questions;
                })
                .catch(error => console.error('Error fetching user response:', error));
        },
		*/
    ...
    callGetQuizResults() {
		...
		this.results.overallScore = data.overall_score;
